/*
	...
	function Sum8(), Sum9()										2013-12-17
	function mySetVisible()										2014-01-22
	function getMonday() 										2014-04-07
	function getFriday() 										2014-04-07
	function AxBeqC( A, B, C )									2014-04-14
	function isNormalInteger()									2014-04-15 
	function StopFormSaveEvent()								2014-04-18 
	function Sum11()											2014-05-21
	function Sum12(), Sum13()									2014-05-21
	function setDefaultLookupItem( sLabel, oValue )
	function removeCurlyBrackets( sString )
	
	Adam Ip														2015-01-07
	function setLookupObject( sLabel, in_id, in_name, in_type )
...
/***************************************************************************************/
function Sum9( sLabel, val1, val2, val3, val4, val5, val6, val7, val8, val9, out1 )
{
	if( DebugModeFmOne ) 
		window.alert( "function Sum8 " + sLabel + "\n\tval1 " + val1 + "\n+\tval2 " + val2 + "\n+\tval3 " + val3 + "\n+\tval4 " + val4 + "\n+\tval5 " + val5 + "\n+\tval6 " + val6 + "\n+\tval7 " + val7 + "\n+\tval8 " + val8 + "\n+\tval9 " + val9 );
...
/***************************************************************************************/
function Sum13( sLabel, val01, val02, val03, val04, val05, val06, val07, val08, val09, val10, val11, val12, val13, out1 )
{
	if( DebugModeFmOne ) 
		window.alert( "function Sum12 " + sLabel + "\n\tval01 " + val01 + "\n+\tval02 " + val02 + "\n+\tval03 " + val03 + "\n+\tval04 " + val04 + "\n+\tval05 " + val05 + "\n+\tval06 " + val06 + "\n+\tval07 " + val07 +  "\n+\tval08 " + val08 + "\n+\tval09 " + val09 + "\n+\tval10 " + val10 + "\n+\tval11 " + val11 + "\n+\tval12 " + val12+ "\n+\tval13 " + val13 );
	...
	try
	{
		...
		{ 
			out1.setSubmitMode( "always" );
			out1.setValue( val01 + val02 + val03 + val04 + val05 + val06 + val07 + val08 + val09 + val10 + val11  + val12 + val13 );
		}	
	}
	catch( err )
	{
...
/**************************************************************************************
Reference: http://charanmandya.blogspot.com/2012/05/microsoft-dynamics-crm-2011-javascript.html#setLookup
*/
function setLookupObject( sLabel, in_id, in_name, in_type )
{
	try
	{
		if( sLabel != null && in_id != null && in_name != null )
		{
			var aLookup, out1 = Xrm.Page.getAttribute( sLabel );
			if( out1 != null )
			{
				aLookup = new Array();
				aLookup[0] = new Object(); 
				aLookup[0].id = in_id;  
				aLookup[0].name = in_name;
				aLookup[0].entityType = in_type;
				out1.setValue( aLookup );
			}
		}	
	}
	catch( err )
	{
		window.alert( "function setLookupObject()\nerr code\t" + err + "\nerr name\t" + err.name + "\nerr message\t" + err.message + "\nerr number\t" + err.number + "\nerr prototype\t" + err.prototype  + "\nerr toString\t" + err.toString());
	}
}
...
function setDefaultLookupItem( sLabel, oValue )
{
	...
	{
		window.alert( "function setDefaultLookupItem()\nerr code\t" + err + "\nerr name\t" + err.name + "\nerr message\t" + err.message + "\nerr number\t" + err.number + "\nerr prototype\t" + err.prototype  + "\nerr toString\t" + err.toString());
	}
}
